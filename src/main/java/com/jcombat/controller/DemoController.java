...
import com.jcombat.bean.Registration;
...
public class DemoController {
	...
	public String register(@ModelAttribute("register") Registration registration,  ModelMap model, HttpServletRequest request) {
	...
	public void doReg(@ModelAttribute("mywishlist") Registration registration,HttpServletRequest request, HttpServletResponse response) {
